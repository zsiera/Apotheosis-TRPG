...
/**
 * @author Evan Stewart
 * A data storage class that holds an inventory of items, weapons, and armor
 * as well as \a quantity of funds.  Used to keep track of inventories and 
 * for each faction on a map as well as shop inventories.
 */
public class Convoy {
