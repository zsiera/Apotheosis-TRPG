 ...
 * @author Evan
 * 
 * A class that handles the loading and caching of spritesheets, among other
 * things.
 */
public class SpriteSheet {
    ...
    /*public static final SpriteSheet FARCHERMAP = new SpriteSheet
            ("/res/images/units/map/FArcherMap.png", 101, 126, -16469967);
    public static final SpriteSheet KAELLMAP = new SpriteSheet
    ...
    /*public static final SpriteSheet WEAPONICONSET = new SpriteSheet
            ("/res/images/icons/WeaponIconset.png", 18, 18,-16776961);
    public static final SpriteSheet ITEMICONSET = new SpriteSheet
            ("/res/images/icons/ItemIconset.png", 18, 18,-16776961);
    public static final SpriteSheet ARMORICONSET = new SpriteSheet
            ("/res/images/icons/ArmorIconset.png", 18, 18,-16776961);
    public static final SpriteSheet KAELLMAPFACE = new SpriteSheet
